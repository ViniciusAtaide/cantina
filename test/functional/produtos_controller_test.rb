...
class ProdutosControllerTest < ActionController::TestCase
  ...
  test "should create produto" do
    assert_difference('Produto.count') do
      post :create, produto: { descricao: @produto.descricao, nome: @produto.nome, preco_venda: @produto.preco_venda, unidade_medida: @produto.unidade_medida }
    end
  ...
  test "should update produto" do
    put :update, id: @produto, produto: { descricao: @produto.descricao, nome: @produto.nome, preco_venda: @produto.preco_venda, unidade_medida: @produto.unidade_medida }
    assert_redirected_to produto_path(assigns(:produto))
  end
